    ...
    return ( 
        <section className="section1" id="section1">
            ...
            <div className="section1-items-container">
                ...
                <div id="item2"><form action="#section2"><button onclick="window.location.href='/#section2'">View my work <span id="arrow" class="iconify" data-icon="mdi:arrow-right"></span> </button></form></div>
            </div>
        </section>
     );
}
