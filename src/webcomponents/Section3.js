const Section3 = () => {
    return ( 
        <section className="section3">
            ...
            <div className="projects-container birds"> <img src="https://images.unsplash.com/photo-1563986768711-b3bde3dc821e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1168&q=80"  className="image"/>   <div className="middle"> <div> <h2>ChowNow Discover</h2> <p>React JS / Python</p> </div> <div> <button>LEARN MORE</button> </div> </div> </div>
                

            
            <div className="projects-container fish"> <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1115&q=80"  className="image"/>   <div className="middle"> <div> <h2>ChowNow Discover</h2> <p>React JS / Python</p> </div> <div> <button>LEARN MORE</button> </div> </div> </div>
